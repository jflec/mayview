global.CarePackageFX = (function () {
  ...
  function generic(context, opts) {
    ...
    particle(ctx, "minecraft:poof", p, 0.1, 0.3, 0.1, 0.05, opts.poofCount == null ? 10 : opts.poofCount, "normal");
    particle(ctx, "minecraft:cloud", p, 0.45, 0.45, 0.45, 0.05, opts.cloudCount == null ? 12 : opts.cloudCount, "normal");

    var accents = opts.accents;
    if (!accents) {
      accents = [
        {id: "minecraft:glow", dx: 0.35, dy: 0.25, dz: 0.35, speed: 0.08, count: 8, mode: "normal"},
        {id: "minecraft:happy_villager", dx: 0.35, dy: 0.2, dz: 0.35, speed: 0.01, count: 4, mode: "normal"}
      ];
    }
  ...
  function pokemon(context, opts) {
    ...
    particle(ctx, "minecraft:poof", p0, 0.1, 0.3, 0.1, 0.05, 8, "normal");
    particle(ctx, "minecraft:cloud", p0, 0.5, 0.5, 0.5, 0.05, 14, "normal");
    particle(ctx, "minecraft:end_rod", p0, 0.5, 0.5, 0.5, 0.1, 14, "normal");
    particle(ctx, "minecraft:totem_of_undying", p1, 0.4, 0.35, 0.4, 0.05, 14, "normal");
    particle(ctx, "minecraft:happy_villager", p0, 0.4, 0.4, 0.4, 0.005, 18, "normal");
